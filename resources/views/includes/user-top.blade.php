            ...
            <div class="noti-wrap">
                ...
                <div class="account-wrap">
                    <div class="account-item clearfix js-item-menu">
                        ...
                        <div class="content">
                            <a class="js-acc-btn" href="#">{{ $userinfo[1] }}</a>
                        </div>

                        <div class="account-dropdown js-dropdown">
                            <div class="info clearfix">
                                <div class="image"><a href="#"><img src="/img/{{ $userinfo[5] }}" alt="{{ $userinfo[1] }}" /></a></div>
                                <div class="content">
                                    <h5 class="name"><a href="#">{{ $userinfo[1] }}</a></h5><span class="email">{{ $userinfo[2] }}</span>
                                </div>
                            </div>
                            <div class="account-dropdown__body">
                                <div class="account-dropdown__item"><a href="#"><i class="zmdi zmdi-account"></i>Account</a></div>
                                <div class="account-dropdown__item"><a href="#"><i class="zmdi zmdi-settings"></i>Settings</a></div>
                                <div class="account-dropdown__item"><a href="#"><i class="zmdi zmdi-money-box"></i>Billing</a></div>
                            </div>
                            <div class="account-dropdown__footer"><a href="/logout" onclick="return confirm('Are you sure you want to log out?')"><i class="zmdi zmdi-power"></i>Logout</a></div>
                        </div>
                    </div>
                </div>
